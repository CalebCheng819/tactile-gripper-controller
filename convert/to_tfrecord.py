...
observation/robot_state/tactile_values
observation/robot_state/human_intervention
...
OBS_KEY_MAPPING = {
    "observation/exterior_image_1_left": ["observation/image/24013089_left", # right camera
                                          "observation/image/25047636_left"],  # left camera
    "observation/exterior_image_1_right": ["observation/image/24013089_right", # right camera
                                           "observation/image/25047636_right"],  # left camera
    "observation/joint_position": "observation/robot_state/joint_positions",
    "observation/gripper_position": "observation/robot_state/gripper_position",
    "observation/tactile_values": "observation/robot_state/tactile_values",
}

ACT_KEY_MAPPING = ["action/joint_position", "action/gripper_position"]

PROMPT_MAPPING = {
    "Picking up a paper cup": "cup",
    "Picking up a paper box": "box",
    "Picking up a glass cup": "glass",
}
