...
CKPT_BASE_PATHS = ["/home/soroush/code/04-17-None-ct4/seed_1_ds_real50-counter-to-cab_mg50/20240417221847/models/model_epoch_500.pth"] #[os.path.join("~/expdata/r2d2/im/bc_ret_pt", p) for p in [
    # ### old ckpts ###
