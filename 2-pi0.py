...
class babyFORTEReader:
    def __init__(self, cfg, shutdown_event, shared_force_buffer, force_estimator_process) -> None:
        ...
        self.force_estimator_process = force_estimator_process
        self.shared_force_buffer = shared_force_buffer
        self._test_cnt = 1
...
def main(cfg: DictConfig):
    ...
    tactile_reader = babyFORTEReader(cfg, shutdown_event, shared_force_buffer, None)
    ...
    tactile_reader.force_estimator_process = force_estimator_process
    ...
    while True:
        ...
        for t_step in bar:
            ...
            try:
                ...
                ## To-do 3 -- done 
                # function from force_estr_nn.py --> for MLPInference
