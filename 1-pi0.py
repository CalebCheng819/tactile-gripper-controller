...
# ruff: noqa
# no tactile -- bug 
# tactile config may have issue due to notactile 
# inference policy --
# 10 policy horizon -- teleoperation frequency -- each action how many seconds 
    ...
    while True:
        ...
        for t_step in bar:
            ...
            try:
                ...
                print(f"pi0 gripper value (raw): {action[-1]}")
                ...
                # Print gripper value after binarization
                print(f"pi0 gripper value (binarized): {action[-1]}")
